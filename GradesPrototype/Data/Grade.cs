...
namespace GradesPrototype.Data
{
    ...
    public abstract class User
    {
        ...
        public string Password
        {
            set
            {
                ...
                {
                    throw new ArgumentException("Unable to set password.");
                }
    ...
    public class Student: User, IComparable<Student>
    {
        ...
        public override bool SetPassword(string pass)
        {
    ...
    public class Teacher : User
    {
        ...
        {
            Match matchPass = Regex.Match(password, @".*[0-9]+.*[0-9]+.*");
            if(!(matchPass.Success))
            {
                return false;
                throw new ArgumentException("Does not meet validation requirement");
            }
            else
            {
                _password = password;
